...
public class loadEvents {
    public loadEvents(Drupi drupi) {
        ...
        eventsToListenFor.add(BatToggleSleepEvent.class);
        ...
        eventsToListenFor.add(EntityDropItemEvent.class);
        ...
        eventsToListenFor.add(EntityPlaceEvent.class);
        ...
        eventsToListenFor.add(EntityPotionEffectEvent.class);
        ...
        eventsToListenFor.add(EntitySpawnEvent.class);
        ...
        eventsToListenFor.add(EntityToggleSwimEvent.class);
        eventsToListenFor.add(EntityTransformEvent.class);
        ...
        eventsToListenFor.add(PigZombieAngerEvent.class);
        ...
        eventsToListenFor.add(PlayerCommandSendEvent.class);
        ...
        eventsToListenFor.add(PlayerItemDamageEvent.class);
        ...
        eventsToListenFor.add(PlayerRecipeDiscoverEvent.class);
        ...
        eventsToListenFor.add(PlayerRiptideEvent.class);
        ...
        eventsToListenFor.add(BlockCookEvent.class);
        eventsToListenFor.add(BlockDamageEvent.class);
        eventsToListenFor.add(BlockDispenseArmorEvent.class);
        eventsToListenFor.add(BlockDispenseEvent.class);
        eventsToListenFor.add(BlockDropItemEvent.class);
        ...
        eventsToListenFor.add(BlockFertilizeEvent.class);
        ...
        eventsToListenFor.add(FluidLevelChangeEvent.class);
        eventsToListenFor.add(LeavesDecayEvent.class);
        eventsToListenFor.add(MoistureChangeEvent.class);
        eventsToListenFor.add(NotePlayEvent.class);
        eventsToListenFor.add(SignChangeEvent.class);
        eventsToListenFor.add(SpongeAbsorbEvent.class);
