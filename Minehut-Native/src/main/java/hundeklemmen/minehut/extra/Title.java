 ...
 */
package hundeklemmen.minehut.extra;
...
public class Title {
    ...
    public void send(Player player) {
        try {
            ...
            // NMS Classes
            Class<?> clsPacketPlayOutTitle = hundeklemmen.minehut.extra.ServerPackage.MINECRAFT.getClass("PacketPlayOutTitle");
            Class<?> clsPacket = hundeklemmen.minehut.extra.ServerPackage.MINECRAFT.getClass("Packet");
            Class<?> clsIChatBaseComponent = hundeklemmen.minehut.extra.ServerPackage.MINECRAFT.getClass("IChatBaseComponent");
            Class<?> clsChatSerializer = hundeklemmen.minehut.extra.ServerPackage.MINECRAFT.getClass("IChatBaseComponent$ChatSerializer");
            Class<?> clsEnumTitleAction = hundeklemmen.minehut.extra.ServerPackage.MINECRAFT.getClass("PacketPlayOutTitle$EnumTitleAction");
