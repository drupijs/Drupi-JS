...
import net.stacket.drupi.legacy.script.FunctionManager;
import net.stacket.drupi.legacy.script.commandManager;
import net.md_5.bungee.api.ChatColor;
import net.stacket.drupi.v1_8.utils;
...
public class util {
    ...
    public static boolean unregisterCommands(){
        ...
        if(MainPlugin.serverVersion.startsWith("v1_8")||MainPlugin.serverVersion.startsWith("v1_9")||MainPlugin.serverVersion.startsWith("v1_10")||MainPlugin.serverVersion.startsWith("v1_11")||MainPlugin.serverVersion.startsWith("v1_12")) {
            knownCommands = utils.getField(commandMap, "knownCommands");
        } else {
            try {
                knownCommands = (Map<String, Command>) net.stacket.drupi.v1_13.utils.getPrivateField(commandMap, "knownCommands");
