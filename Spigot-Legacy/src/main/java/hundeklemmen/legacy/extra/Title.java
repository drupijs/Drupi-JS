...
public class Title {
    ...
    public void send(Player player) {
        try {
            ...
            // NMS Classes
            Class<?> clsPacketPlayOutTitle = hundeklemmen.legacy.extra.ServerPackage.MINECRAFT.getClass("PacketPlayOutTitle");
            Class<?> clsPacket = hundeklemmen.legacy.extra.ServerPackage.MINECRAFT.getClass("Packet");
            Class<?> clsIChatBaseComponent = hundeklemmen.legacy.extra.ServerPackage.MINECRAFT.getClass("IChatBaseComponent");
            Class<?> clsChatSerializer = hundeklemmen.legacy.extra.ServerPackage.MINECRAFT.getClass("IChatBaseComponent$ChatSerializer");
            Class<?> clsEnumTitleAction = hundeklemmen.legacy.extra.ServerPackage.MINECRAFT.getClass("PacketPlayOutTitle$EnumTitleAction");
